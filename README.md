...
[![Lint](https://github.com/drorhayun/jsonschema/actions/workflows/lint.yaml/badge.svg)](https://github.com/drorhayun/jsonschema/actions/workflows/lint.yaml)
[![Test Go](https://github.com/drorhayun/jsonschema/actions/workflows/test.yaml/badge.svg)](https://github.com/drorhayun/jsonschema/actions/workflows/test.yaml)
[![Go Report Card](https://goreportcard.com/badge/github.com/drorhayun/jsonschema)](https://goreportcard.com/report/github.com/drorhayun/jsonschema)
[![GoDoc](https://godoc.org/github.com/drorhayun/jsonschema?status.svg)](https://godoc.org/github.com/drorhayun/jsonschema)
...
- Support for `yaml` tags and related options has been dropped for the sake of simplification. There were a [few inconsistencies](https://github.com/drorhayun/jsonschema/pull/21) around this that have now been fixed.
...
Support for `yaml` tags has now been removed. If you feel very strongly about this, we've opened a discussion to hear your comments: https://github.com/drorhayun/jsonschema/discussions/28
...
```go
r := new(Reflector)
if err := r.AddGoComments("github.com/drorhayun/jsonschema", "./"); err != nil {
  // deal with error
}
s := r.Reflect(&User{})
// output
