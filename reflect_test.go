...
import (
	...
	"github.com/drorhayun/jsonschema/examples"
...
func TestReflectFromType(t *testing.T) {
	...
	assert.EqualValues(t, "https://github.com/drorhayun/jsonschema/test-user", s.ID)
...
func prepareCommentReflector(t *testing.T) *Reflector {
	t.Helper()
	r := new(Reflector)
	err := r.AddGoComments("github.com/drorhayun/jsonschema", "./examples")
